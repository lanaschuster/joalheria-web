...
export default Vue.extend({
  ...
  methods: {
    excluir() {
      ...
      $axios.$delete(`/api/providers/${this.id}`)
        .then(r => {
          this.loading = false
          snackbar.setMessage('Fornecedor excluído com sucesso')
        ...
        .catch(error => {
          ...
          if (error.response && error.response.data) {
            ...
            snackbar.setMessage(
              'Não foi possível excluir o fornecedor, tente mais tarde.'
            )
          }
